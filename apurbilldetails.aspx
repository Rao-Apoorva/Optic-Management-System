<%@ Page Language="C#" AutoEventWireup="true" CodeFile="apurbilldetails.aspx.cs" Inherits="apurbilldetails" %>
...
<body>
   ...
   <li><a href="default.aspx"><i class="fa fa-sign-out"></i> LOGOUT</a></li>
    ...
    <div>
        <asp:Panel ID="Panel1" runat="server" style="left: 441px; position: absolute; top: 253px;">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Font-Names="Times New Roman"
                Font-Size="14pt" Width="695px" ForeColor="#000000" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                <Columns>
