<%@ Page Language="C#" AutoEventWireup="true" CodeFile="apurreturndetail.aspx.cs" Inherits="apurreturndetail" %>
...
<body>
   ...
   <li><a href="default.aspx"><i class="fa fa-sign-out"></i> LOGOUT</a></li>
    ...
    <li><a href="aunblock.aspx">UNBLOCK</a></li>
     ...
     <div>
        <asp:Panel ID="Panel1" runat="server" style="left: 343px; position: absolute; top: 269px">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Font-Names="Times New Roman" Font-Size="14pt" Width="953px" Font-Bold="False" ForeColor="#000000">
            <Columns>
            <asp:BoundField DataField="Prno" HeaderText="PURCHASE RETURN NO." />
            <asp:BoundField DataField="Pbno" HeaderText="PURCHASE BILL NO." />
