<%@ Page Language="C#" AutoEventWireup="true" CodeFile="assearch.aspx.cs" Inherits="assearch" %>
...
<body>
   ...
   <li><a href="default.aspx"><i class="fa fa-sign-out"></i> LOGOUT</a></li>
    ...
    <div style="text-align: center">
        <strong><span style="font-family: Cambria"><span style="font-size: 14pt">&nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            ...
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span></span></strong>&nbsp;&nbsp;
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
        <asp:Panel ID="Panel1" runat="server" Style="left: 517px; position: absolute; top: 247px">
            <table style="width: 468px">
                <tr>
                    <td style="width: 100px">
                        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Names="Cambria" Font-Size="14pt"
                            Text="Select Supplier Name  and Enter Address" Width="287px" ForeColor="Black"></asp:Label></td>
                    <td style="width: 100px">
                        <br />
                        <asp:DropDownList ID="DropDownList1" runat="server" AppendDataBoundItems="True" AutoPostBack="True"
                            DataSourceID="SqlDataSource1" DataTextField="sname" DataValueField="sname" Font-Names="Cambria"
                            Font-Size="14pt">
                            <asp:ListItem>--SELECT--</asp:ListItem>
                        </asp:DropDownList><br />
                        <br />
                        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=LAPTOP-H3MPTQHS;Initial Catalog=project;Integrated Security=true" SelectCommand="SELECT [sname] FROM [supplier]">
                        </asp:SqlDataSource>
                        <br />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <br />
                        <asp:Button ID="btnsearch" runat="server" Font-Bold="True" Font-Names="Cambria" Font-Size="14pt"
                            OnClick="btnsearch_Click" Text="SEARCH" Width="140px" />
                        <br />
                        <br />
                        <br />
                    </td>
        ...
        <br />
        <br />
        <table style="left: 122px; width: 446px; position: absolute; top: 506px;">
            <tr align="center">
                <td style="width: 100px; text-align: center;">
                    <span style="font-size: 24pt; font-family: Cambria">
                        <br />
                        &nbsp;&nbsp;
                        <asp:Label ID="Label1" runat="server" Text="SUPPLIER DETAILS" Width="317px" Font-Names="Cambria" Font-Size="16pt" Font-Bold="True" ForeColor="Black"></asp:Label><br />
                    </span></td>
            </tr>
            <tr align="center">
                <td style="width: 100px">
                    <asp:GridView ID="gdemp" runat="server" Font-Names="Times New Roman" Font-Size="14pt" AutoGenerateColumns="False" ForeColor="Black">
                        <Columns>
